...
- (void)postToTwitter
{
    ...
    [tweetSheet setInitialText:[NSString stringWithFormat:@"%@ - Animation by @KidneyJohn - https://www.youtube.com/watch?v=%@", videoTitleFromList, videoIdFromList]];
...
- (void)viewDidLoad
{
    ...
    navLabel.text = videoTitleFromList;
